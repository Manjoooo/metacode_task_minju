...
### 3-4. event_time, producer_time, ingest_time 분리
...
## 6-2. Silver Layer: processed_ad_journeys
...
## 6-3. Gold Layer: campaign_summary
...
## 8. Daily Peak 및 Scale In/Out 전략
...
## 9-1. Late Conversion으로 과거 KPI가 변경되는 문제
...
## 9-2. Producer 재전송 또는 Streaming 재시작으로 인한 중복 이벤트
...
## 9-3. Streaming Ingestion으로 인한 Small File 증가
...
### 11-4. file count와 average file size
...
### 11-5. Silver vs Gold consistency
